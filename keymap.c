...
[_QWERTY] = LAYOUT_planck_mit( \
  ...
  KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_PIPE, KC_ENT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH, \
  KC_LCTL, KC_LGUI, KC_LALT, RAISE,   LOWER,   KC_SPC,           KC_RALT, KC_SCLN, KC_LEFT, KC_DOWN, KC_RGHT \
),
...
[_RAISE] = LAYOUT_planck_mit( \
  ...
  KC_LSFT, KC_SLSH, KC_BSLS, KC_QUOT, _______, KC_MINS, KC_UNDS, KC_PLUS, KC_EQL,  KC_LCBR, KC_RCBR, KC_RSFT, \
